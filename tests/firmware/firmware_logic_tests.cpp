...
/**
 * A HOST stop (zero motors, selector still set) is rewritten into the handback form only
 * while an Audio Haptics session is running; otherwise the host's payload is left alone.
 */
